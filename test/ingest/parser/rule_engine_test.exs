defmodule Ingest.Parser.RuleEngineTest do
  use ExUnit.Case, async: true

  alias Ingest.Parser.RuleEngine
  alias Ingest.Parser.Rules.{ChapterRules, ParagraphRules, SpeakerRules}
  alias Ingest.Parser.TextUtils
  ...
  describe "SpeakerRules.detect_speakers/2" do
    test "detects known speakers" do
      paragraphs = [
        %Ingest.Schema.Paragraph{n: 1, text: "Yahweh: Hello", confidence: 1.0},
        %Ingest.Schema.Paragraph{n: 2, text: "Just narration.", confidence: 1.0}
      ]
    ...
    test "flags dialogue with unknown speaker" do
      paragraphs = [
        %Ingest.Schema.Paragraph{n: 1, text: "\u2014 Some dialogue", confidence: 1.0}
      ]
