defmodule Ingest.LLM.Client do
  @moduledoc """
  ...
  defp chat_zai(prompt, opts) do
    api_key = Application.get_env(:ingest, :zai_api_key)
  ...
  defp chat_anthropic(prompt, opts) do
    api_key = Application.get_env(:ingest, :anthropic_api_key)
  ...
  defp default_provider do
    cond do
      Application.get_env(:ingest, :zai_api_key) -> :zai
      Application.get_env(:ingest, :anthropic_api_key) -> :anthropic
      true -> :zai
    end
  end
