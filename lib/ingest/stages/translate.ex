defmodule Ingest.Stages.Translate do
  @moduledoc """
  Stage 3: Translation.
  ...
  alias Ingest.Stages.{Normalize, WorkDir}
  alias Ingest.Translator
  ...
  def run(slug, opts \\ []) do
    langs = Keyword.get(opts, :langs,
      Application.get_env(:ingest, :default_languages, ~w(en fr de es ru ja zh)))
