defmodule Mix.Tasks.Ingest.Export do
  @moduledoc """
  ...
  ## Usage
      ...
      mix ingest.export --slug my-book
      mix ingest.export --slug my-book --output ../data-library
  ...
  def run(args) do
    ...
    translated? = Ingest.Stages.Translate.done?(slug)
    ...
    case Ingest.Stages.Export.run(slug, export_opts) do
      {:ok, path} ->
